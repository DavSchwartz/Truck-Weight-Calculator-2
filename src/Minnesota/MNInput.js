				...
				<div className='flexRowMainContent'>
					...
					<div>
						...
						<FlexBoxRow class='flexItemAxleDetails'>{{
								...
								two: <div><input className='txtBox' type='text' name='tireRating' value={truck.tireRating[currentAxle]} onChange={this.handleChange.bind(this,0)}/>
										<WeightUnitDropDown weightUnit={truck.weightUnit[currentAxle]} handleChange={this.handleChange.bind(this,0)}/></div>,
								three: '',
								four: <div><input className='txtBox' type='text' name='tireRating' value={truck.tireRating[currentAxle+1]} onChange={this.handleChange.bind(this,1)}/>
